    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Enhanced monochromatic white glow beneath card */}
...
// Project Images - All 20 unique project images (REVERSED ORDER)
const IMAGES = [
  "/images/projects/tindog.png",
  "/images/projects/syntropy1.png",
  "/images/projects/skilltrade.png",
  "/images/projects/resqx.png",
  "/images/projects/pulseroom.png",
  "/images/projects/novaaid.png",
  "/images/projects/netflix.png",
  "/images/projects/medsecure.png",
  "/images/projects/helix.png",
  "/images/projects/healix.png",
  "/images/projects/genz.png",
  "/images/projects/forever.png",
  "/images/projects/eecho.png",
  "/images/projects/brainly.png",
  "/images/projects/animated.png",
  "/images/projects/amazon.png",
  "/images/projects/aerosense.png",
      ...
      <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
        ...
        >
          ...
          <p className="max-w-lg text-sm leading-relaxed text-muted-foreground md:text-base">
            Discover projects spanning Web3, AI/ML, and full-stack development.{" "}
            <br className="hidden md:block" />
            Each card represents a unique solution to real-world challenges.
          </p>
        </motion.div>
