...
export function VerticalImageStack({ images, className = "" }: VerticalImageStackProps) {
  ...
  return (
    <div className={`relative flex h-screen w-full items-center justify-center overflow-hidden bg-background ${className}`}>
      {/* Subtle ambient glow */}
      ...
      {/* Card Stack */}
      <div className="relative flex h-150 w-125 items-center justify-center" style={{ perspective: "1200px" }}>
        {images.map((image, index) => {
          ...
          return (
            ...
            >
              <div
                className="relative h-140 w-125 overflow-hidden rounded-3xl bg-card ring-1 ring-border/20"
                style={{
                  boxShadow: isCurrent
